...
class MMCVResNet(BaseModule):
    ...
    def init_weights(self):
        if self.init_cfg is None:
            ...
            super(MMCVResNet, self).init_weights()
...
@BACKBONES.register_module()
class MMCVResTiny(MMCVResNet):

    def __init__(self,num_stages=4,out_index=[0,1,2,3],block=BasicBlock, **kwargs) -> None:
    ...
    def forward(self, x):   
        ...
        feats = [feats[i] for i in self.out_index]
        return feats
